...
/**
 ...
 @Author：xpl
 @version:  4.3.2 2023-06-17 兼容IE8浏览器
...
layui.extend({
    ...
    "use strict";
    /***
     * 兼容IE浏览器，不支持indexOf时，先执行一次，之后indexof就兼容了。
     * @returns
     */
    ...
    var createInstance = function(_config){
        ...
        instance.buildConditionHtml = function(){
            ...
            if(instance.config.conditionTextId && instance.config.displayModel == "popup"){
                ...
                msgJq.find(".layui-xpl-dc-delete").on("click",function(){
                    var thatObj = this;
                    try{
                        instance.deleteCondition(thatObj);
                    }catch (e) {
        ...
        /**删除条件*/
        instance.deleteCondition = function(ele){
