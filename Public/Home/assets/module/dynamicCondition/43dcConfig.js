...
layui.define(['jquery'], function (exports) {
    ...
    var myConfig  = {
    		...
    		requestDataType: 'json',//取值：'array'/'json'.请求参数类型。默认array。
    		...
    		counts: 1,//默认初始化条件数。
    		popupMsgText: "",//弹窗模式下msg默认提示文本。之前版本默认为“查询条件：”
    		popupBtnsWidth: 60,//弹窗模式下按钮工具面板宽度。500px
    		popupShowQueryBtn: false, //弹窗模式下，是否显示查询按钮。之前版本默认是不显示的
    		unpopupBtnswidth: 180,//非弹窗模式下按钮工具面板宽度。180px
    		...
    		extendBtns:function(btnDivJq, instance){
    			//下面可以添加扩展按钮
    			if($("#toolbarBts").length>0){//弹窗模式统一改为非弹窗模式
		    	...
		    	// btnDivJq.append($("<a class='delRowBtn'>扩展按钮1</a>"));
